...
const translations = {
  ...
  'prog.overview': { he: 'סקירה כללית', en: 'Overview' },
  'prog.drillDown': { he: 'פירוט מלא', en: 'Full Details' },
  'prog.change': { he: 'שינוי', en: 'Change' },
  'prog.pr': { he: 'שיא אישי', en: 'Personal Record' },
  'prog.trend': { he: 'מגמה', en: 'Trend' },
  'prog.improving': { he: 'שיפור', en: 'Improving' },
  'prog.stable': { he: 'יציב', en: 'Stable' },
  'prog.declining': { he: 'ירידה', en: 'Declining' },
  'prog.sessions': { he: 'אימונים', en: 'Sessions' },
  'prog.latestWeight': { he: 'משקל אחרון', en: 'Latest Weight' },
  'prog.latestReps': { he: 'חזרות אחרון', en: 'Latest Reps' },
  'prog.latestVolume': { he: 'נפח אחרון', en: 'Latest Volume' },
  'prog.firstRecord': { he: 'רישום ראשון', en: 'First Record' },
  'prog.percentChange': { he: 'שינוי באחוזים', en: '% Change' },
  'prog.showCharts': { he: 'הצג גרפים', en: 'Show Charts' },
  'prog.hideCharts': { he: 'הסתר גרפים', en: 'Hide Charts' },
  'prog.avgPerSession': { he: 'ממוצע לאימון', en: 'Avg per Session' },
