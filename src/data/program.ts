...
export const PROGRAM: RoutineDef[] = [
  {
    ...
    exercises: [
      ...
      { id: 'a-plyo', name: 'Explosive Step-Up', target: '3×3-4', setsDefault: 3, repsDefault: 4, area: 'ברך', gym: { note: 'קופסה 15-20 ס"מ בלבד (ברכיים!)' }, home: { name: 'Broad Jump + Stick', note: 'קצר ומבוקר, נעל את הנחיתה' }, params: [{ key: 'boxH', label: 'גובה קופסה', unit: 'ס"מ', step: 1, def: 18 }],
  ...
  },
  {
    ...
    exercises: [
      { id: 'b-pull', name: 'Vertical Pull', target: '3× מקס+3-8', setsDefault: 3, repsDefault: 6, weighted: true, area: 'כתף', gym: { name: 'Pull-Ups' }, home: { name: 'Ring Pull-Ups', note: 'אחיזה ניטרלית — עדין לכתפיים' },
        tips: ['רז: התחל מכתפיים "בכיס" — מושכים את השכמות למטה לפני שהמרפקים.', 'נעה: אחיזה ניטרלית עדינה יותר לכתפיים. בלי נדנוד — משיכה נקייה.', 'עמית: מקס נקי + עוד 3-8 בעזרה. איכות החזרה מעל הכמות.', 'טל: ירידה מבוקרת 2-3 שניות — שם נבנה חצי מהשריר.'] },
      { id: 'b-dip', name: 'Vertical Push', target: '3×3-8', setsDefault: 3, repsDefault: 6, weighted: true, area: 'כתף', gym: { name: 'Dips' }, home: { name: 'Ring Dips / Negatives', note: 'התחל משליליים איטיים' },
        tips: ['מאיה: ירידה עד 90 מעלות בלבד — לא נמוך יותר, שומרים על הכתף.', 'נעה: גוף מעט קדימה, שכמות אסופות. בלי לצנוח לתחתית.', 'עמית: אין עדיין כוח? שליליים איטיים — יורדים 3-4 שניות. זה בונה.', 'רז: נעל את התחתית, דחוף מתפרץ למעלה — כוח דחיפה קרבי.'] },
      { id: 'b-row', name: 'Row', target: '3×8-12', setsDefault: 3, repsDefault: 10, area: 'גב עליון', gym: { name: 'Australian Pull-Ups' }, home: { name: 'Ring Rows', note: 'רגליים קדימה = קשה יותר' },
        tips: ['נעה: מושכים עם המרפקים לכיס האחורי, שכמות נסגרות. לא עם הידיים.', 'עמית: רגליים קדימה = קשה יותר. משחקים עם הזווית, לא עם המשקל.', 'רז: גוף קשיח כמו קרש כל החזרה — הליבה עובדת בדיוק כמו הגב.', 'טל: עצירה קטנה למעלה, סחיטה — שנייה שמכפילה את התרגיל.'] },
      { id: 'b-push', name: 'Horizontal Push', target: '3×10-15', setsDefault: 3, repsDefault: 12, area: 'כתף', gym: { name: 'Wide Deficit Push-Ups' }, home: { name: 'Ring Push-Ups', note: 'ליבה חזקה, גוף ישר' },
        tips: ['נעה: גוף ישר כמו קרש — בטן וישבן נעולים. בלי שקיעה בגב התחתון.', 'רז: ירידה עד שהחזה כמעט נוגע, מרפקים בערך 45 מעלות. עומק מלא.', 'עמית: קל מדי? האט את הטמפו או הגבה את הרגליים. לא ממהרים.', 'טל: דחיפה מתפרצת למעלה, ירידה מבוקרת. קצב הוא כוח.'] },
      { id: 'b-core', name: 'Hanging Core', target: '3×5-10', setsDefault: 3, repsDefault: 8, area: 'גב תחתון', gym: { name: 'Hanging Knee Raises', note: 'מבוקר, בלי נדנוד' }, home: { name: 'Ring Knee Raises' },
        tips: ['מאיה: מבוקר לגמרי — בלי נדנוד. נדנוד מעמיס את הגב שאנחנו שומרים עליו.', 'נעה: מתחילים מהטיית אגן — האגן מתגלגל לפני שהברכיים עולות.', 'עמית: 5 נקיות עדיף על 10 עם תנופה. הבטן עובדת, לא המומנטום.'] },
      { id: 'b-hold', name: 'Support Hold', target: '3×15-25 שנ\'', setsDefault: 3, repsDefault: 20, timeBased: true, area: 'כתף', gym: { name: 'Parallel Bar Hold' }, home: { name: 'Ring Support Hold', note: 'זרועות ישרות, טבעות צמודות' },
        tips: ['נעה: זרועות ישרות נעולות, שכמות למטה. הכתף פעילה כל השנייה.', 'רז: טבעות צמודות לגוף — יציבות לפני משך. איכות ההחזקה קודמת.', 'עמית: מתחילים מ-15 שניות נקיות ומטפסים. הזמן יבוא.'] },
    ],
    flexibility: [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'c-cossack', name: 'Cossack Squat', target: '3×6-8', setsDefault: 3, repsDefault: 7, weighted: true, area: 'ברך', note: 'טווח שליטה — בלי עומק מקסימלי', gym: { note: 'עם משקל אם קל' }, home: { note: 'משקל גוף / תיק' },
